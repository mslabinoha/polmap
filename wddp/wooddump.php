...
<head>
    ...
    <title>Пункти вантажу лісу</title>
    ...
    <script type="text/javascript">
        ...
        function load() {
            ...
            downloadUrl("/wddp/wdgenxml.php", function (data) {
                ...
                for (var i = 0; i < markers.length; i++) {
                    ...
                    var lnk = "<a href='/wddp/wddetails.php?tid=" + id + "'>Більше інформації...</a><br>";
                    var html = "<b>Розміри пункту:</b> <br/>" + "Довжина: " + lengt + "<br> Ширина: " + width + "<br> Глибина механічного проникнення: " + depth + "<br>" + trashcontent + lnk;
...
if(!isset($_SESSION['session_username'])){echo'<a href="/log/login.php">Увійти</a>';}else{ echo'<a href="/log/logout.php">Вийти</a>';}?></li>
                ...
                <div class="col-md-8 col-md-pull-1">
                    ...
                    <div class="container-fluid">
                       ...
                       <div>
                                <p><img src="http://maps.gstatic.com/mapfiles/ridefinder-images/mm_20_red.png" alt="Red point"> - непідтверджений пункт завантаження</p>
                                <p><img src="http://maps.gstatic.com/mapfiles/ridefinder-images/mm_20_blue.png" alt="Blue point"> - підтверджений пункт завантаження</p>
                                <p><img src="http://maps.gstatic.com/mapfiles/ridefinder-images/mm_20_green.png" alt="Green point"> - пункт завантаження ліквідований</p>
                                <p colspan="2">Клік на маркер виводить інформацію про пункт завантаження лісу</p>
                        </div>
                        <h4>Якщо Ви не знайшли на цій карті пункт завантаження лісу, про який вам відомо, ви можете <a href="/wddp/addwdd.php">додати його</a></h4>
